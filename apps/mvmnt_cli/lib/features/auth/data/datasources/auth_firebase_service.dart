...
import 'package:mvmnt_cli/core/util/crypto_util.dart';
import 'package:mvmnt_cli/features/auth/data/models/auth_model.dart';
    ...
    try {
      ...
      if (currentUser != null) {
        ...
        ActionCodeSettings acs = ActionCodeSettings(
          url:
              '${ApiConfig.baseUrl}/users/customers/verify-email?email=$email&uid=${currentUser.uid}',
